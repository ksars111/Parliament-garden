        ...
        {!isExpanded ? (
          ...
          >
            ...
            <div className="flex-1 min-w-0 h-full sm:h-auto flex flex-col sm:flex-row sm:items-center sm:justify-between py-1 sm:py-0 gap-3 sm:gap-4 pr-4 sm:pr-0">
              ...
              >
                <div className="flex flex-wrap items-center sm:justify-center gap-x-2 gap-y-1">
                  <h3 className="font-extrabold text-base sm:text-base md:text-lg text-zinc-900 leading-snug line-clamp-3 sm:line-clamp-2 break-words">{name || 'Unnamed Specimen'}</h3>
                ...
                {botanicalName ? (
                  <p className="text-xs sm:text-xs md:text-sm italic text-zinc-600 line-clamp-2 sm:line-clamp-1 font-semibold leading-normal">{botanicalName}</p>
                ) : (
                  <p className="text-xs sm:text-xs md:text-sm text-zinc-400 line-clamp-2 sm:line-clamp-1 leading-normal">No botanical name specified</p>
                )}
              </div>
